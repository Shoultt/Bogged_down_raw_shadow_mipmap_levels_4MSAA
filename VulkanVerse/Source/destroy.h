...
void destroy()
{
	...
	vmaDestroyImage(allocator, msaaImage, msaaImageAlloc);
	vkDestroyImageView(device, depthImageView, nullptr);
	vmaDestroyImage(allocator, depthTestImage, depthImageAlloc);
	...
	vmaDestroyImage(allocator, textureImage3, textureImageAlloc3);
	vkDestroySampler(device, textureSampler3, nullptr);
	vkDestroyImageView(device, shadowDepthImageView, nullptr);
	vmaDestroyImage(allocator, shadowDepthImage, shadowDepthImageAlloc);
